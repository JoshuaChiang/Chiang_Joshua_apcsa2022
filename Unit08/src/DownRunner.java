...
public class DownRunner
{
	public static void main( String args[] )
	{
		...
		System.out.println(RayDown.go(new int[] {10,20,30,40,50,-11818,40,30,20,10}));
		System.out.println(RayDown.go(new int[] {32767}));
		System.out.println(RayDown.go(new int[] {255,255}));
		System.out.println(RayDown.go(new int[] {9,10,-88,100,-555,1000}));
		System.out.println(RayDown.go(new int[] {10,10,10,11,456}));
		System.out.println(RayDown.go(new int[] {-111,1,2,3,9,11,20,30}));
		System.out.println(RayDown.go(new int[] {9,8,7,6,5,4,3,2,0,-2,-989}));
